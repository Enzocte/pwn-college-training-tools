...
int main() {
  // Partie Ethernet
  unsigned char dest_mac[6] = {0xfa, 0x42, 0x97, 0x7e, 0xe2, 0x07};
  unsigned char src_mac[6] = {0x76, 0x5d, 0xb2, 0xfa, 0xeb, 0x13};
  ...
  // Partie Ip
    ...
    unsigned char send_mac[6] = {0x3e, 0x42, 0x97, 0x7e, 0xe2, 0x07};
    unsigned char send_ip[4] = {0x0a, 0x00, 0x00, 0x02};
    unsigned char recv_mac[6] = {0x76, 0x5d, 0xb2, 0xfa, 0xeb, 0x13};
    unsigned char recv_ip[4] = {0x0a, 0x00, 0x00, 0x03};
